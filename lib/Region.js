...
var Region = function (_Component) {
	...
	_createClass(Region, [{
		...
		value: function render() {
			...
			if (this.props.data.regionStyle.type === 'target') {
				regionStyle = _style2.default.Target;
				localStyle = {
				...
				regionStyle = _style2.default.Region;
				localStyle = {
			...
			return _react2.default.createElement(
				'div',
				{
					style: (0, _objectAssign2.default)({}, regionStyle, localStyle, this.props.customStyle, this.props.data.regionStyle),
...
Region.propTypes = {
	...
	guid: _propTypes.PropTypes.string.isRequired,
